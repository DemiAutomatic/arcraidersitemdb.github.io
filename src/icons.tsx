...
export function Kofi(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
...
export function Currency(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fill="currentColor"
        d="M32 4C47.464 4 60 16.536 60 32C60 47.464 47.464 60 32 60C16.536 60 4 47.464 4 32C4 16.536 16.536 4 32 4ZM31.333 12C20.6558 12.0002 12.0002 20.6558 12 31.333C12 42.0104 20.6557 50.6668 31.333 50.667C42.0105 50.667 50.667 42.0105 50.667 31.333C50.6668 20.6557 42.0104 12 31.333 12Z"
      ></path>
      <rect fill="currentColor" x="24" width="6" height="64"></rect>
      <rect fill="currentColor" x="34.6667" width="6" height="64"></rect>
    </svg>
  );
}
